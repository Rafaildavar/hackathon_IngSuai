      ...
      <div className="flex-1 p-6 md:p-8 lg:p-12">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            <h1 className="text-5xl md:text-6xl font-bold text-foreground">Upload & Process</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Drag files here or click to browse. Processing starts automatically.
            </p>
          </div>
            ...
            <>
              ...
              {selectedFiles.length > 0 && (
                <div className="space-y-8">
                  <div>
                    <h2 className="text-3xl font-bold mb-6">Selected Files ({selectedFiles.length})</h2>
                  ...
                  <div className="flex justify-center gap-4 pt-6">
                    <Button
                      ...
                      size="lg"
                      className="h-14 px-10 bg-primary hover:bg-primary/90 text-white font-semibold text-base"
